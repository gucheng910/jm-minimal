...
| 文件 | 适用 | 下载 |
|---|---|---|
| `jm-minimal-modern-1.8.3.apk` | Android 7.0+，系统 WebView 80 以上（绝大多数机型） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.8.3/jm-minimal-modern-1.8.3.apk) |
| `jm-minimal-compat-1.8.3.apk` | Android 7.0+，**老系统内核也能跑**（WebView 61 以上；含 ES5 兼容包，体积略大） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.8.3/jm-minimal-compat-1.8.3.apk) |
| `jm-minimal-portable-1.8.3.exe` | Windows 7+ x64（免安装便携版） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.8.3/jm-minimal-portable-1.8.3.exe) |
| `jm-minimal-setup-1.8.3.exe` | Windows 7+ x64（NSIS 安装包） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.8.3/jm-minimal-setup-1.8.3.exe) |
