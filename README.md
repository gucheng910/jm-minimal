...
| 文件 | 适用 | 下载 |
|---|---|---|
| `jm-minimal-modern-1.7.1.apk` | Android 10+ / 新系统（targetSdk 36） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.7.1/jm-minimal-modern-1.7.1.apk) |
| `jm-minimal-compat-1.7.1.apk` | 旧 Android / 带安卓兼容层的鸿蒙 2~4 | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.7.1/jm-minimal-compat-1.7.1.apk) |
| `jm-minimal-portable-1.7.1.exe` | Windows 7+ x64（免安装便携版） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.7.1/jm-minimal-portable-1.7.1.exe) |
| `jm-minimal-setup-1.7.1.exe` | Windows 7+ x64（NSIS 安装包） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.7.1/jm-minimal-setup-1.7.1.exe) |
