...
| 文件 | 适用 | 下载 |
|---|---|---|
| `jm-minimal-modern-1.0.apk` | Android 10+ / 新系统（targetSdk 36） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.0/jm-minimal-modern-1.0.apk) |
| `jm-minimal-compat-1.0.apk` | 旧 Android / 带安卓兼容层的鸿蒙 2~4（targetSdk 29） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.0/jm-minimal-compat-1.0.apk) |
| `jm-minimal-portable-1.0.exe` | Windows 7+ x64（免安装便携版） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.0/jm-minimal-portable-1.0.exe) |
| `jm-minimal-setup-1.0.exe` | Windows 7+ x64（NSIS 安装包） | [下载](https://github.com/gucheng910/jm-minimal/releases/download/v1.0/jm-minimal-setup-1.0.exe) |
